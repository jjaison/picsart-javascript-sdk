...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.RemovebgPost200ResponseData();
  });
  ...
  describe('RemovebgPost200ResponseData', function() {
    it('should create an instance of RemovebgPost200ResponseData', function() {
      // uncomment below and update the code to test RemovebgPost200ResponseData
      //var instance = new PicsartProgrammableImageApis.RemovebgPost200ResponseData();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.RemovebgPost200ResponseData);
    });
