...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.BalanceGet200Response();
  });
  ...
  describe('BalanceGet200Response', function() {
    it('should create an instance of BalanceGet200Response', function() {
      // uncomment below and update the code to test BalanceGet200Response
      //var instance = new PicsartProgrammableImageApis.BalanceGet200Response();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.BalanceGet200Response);
    });
