...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.EffectsGet200Response();
  });
  ...
  describe('EffectsGet200Response', function() {
    it('should create an instance of EffectsGet200Response', function() {
      // uncomment below and update the code to test EffectsGet200Response
      //var instance = new PicsartProgrammableImageApis.EffectsGet200Response();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.EffectsGet200Response);
    });
