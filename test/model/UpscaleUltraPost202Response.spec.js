...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.UpscaleUltraPost202Response();
  });
  ...
  describe('UpscaleUltraPost202Response', function() {
    it('should create an instance of UpscaleUltraPost202Response', function() {
      // uncomment below and update the code to test UpscaleUltraPost202Response
      //var instance = new PicsartProgrammableImageApis.UpscaleUltraPost202Response();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.UpscaleUltraPost202Response);
    });
