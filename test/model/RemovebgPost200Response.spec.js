...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.RemovebgPost200Response();
  });
  ...
  describe('RemovebgPost200Response', function() {
    it('should create an instance of RemovebgPost200Response', function() {
      // uncomment below and update the code to test RemovebgPost200Response
      //var instance = new PicsartProgrammableImageApis.RemovebgPost200Response();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.RemovebgPost200Response);
    });
