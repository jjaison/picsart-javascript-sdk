...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.EffectsGet200ResponseDataInner();
  });
  ...
  describe('EffectsGet200ResponseDataInner', function() {
    it('should create an instance of EffectsGet200ResponseDataInner', function() {
      // uncomment below and update the code to test EffectsGet200ResponseDataInner
      //var instance = new PicsartProgrammableImageApis.EffectsGet200ResponseDataInner();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.EffectsGet200ResponseDataInner);
    });
