...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.Model401Error();
  });
  ...
  describe('Model401Error', function() {
    it('should create an instance of Model401Error', function() {
      // uncomment below and update the code to test Model401Error
      //var instance = new PicsartProgrammableImageApis.Model401Error();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.Model401Error);
    });
