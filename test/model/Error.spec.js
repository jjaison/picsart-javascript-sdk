...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new PicsartProgrammableImageApis.Error();
      //expect(instance).to.be.a(PicsartProgrammableImageApis.Error);
    });
