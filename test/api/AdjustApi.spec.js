...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.AdjustApi();
  });
  ...
  describe('AdjustApi', function() {
    describe('adjustPost', function() {
      it('should call adjustPost successfully', function(done) {
        //uncomment below and update the code to test adjustPost
        //instance.adjustPost(function(error) {
    ...
    describe('editPost', function() {
      it('should call editPost successfully', function(done) {
        //uncomment below and update the code to test editPost
        //instance.editPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
