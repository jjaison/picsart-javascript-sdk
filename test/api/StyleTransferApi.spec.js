...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.StyleTransferApi();
  });
  ...
  describe('StyleTransferApi', function() {
    describe('styletransferPost', function() {
      it('should call styletransferPost successfully', function(done) {
        //uncomment below and update the code to test styletransferPost
        //instance.styletransferPost(function(error) {
