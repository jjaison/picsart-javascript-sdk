...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.ContentGenerationApi();
  });
  ...
  describe('ContentGenerationApi', function() {
    describe('backgroundTexturePost', function() {
      it('should call backgroundTexturePost successfully', function(done) {
        //uncomment below and update the code to test backgroundTexturePost
        //instance.backgroundTexturePost(function(error) {
