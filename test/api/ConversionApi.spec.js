...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.ConversionApi();
  });
  ...
  describe('ConversionApi', function() {
    describe('vectorizerPost', function() {
      it('should call vectorizerPost successfully', function(done) {
        //uncomment below and update the code to test vectorizerPost
        //instance.vectorizerPost(function(error) {
