...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.EffectsApi();
  });
  ...
  describe('EffectsApi', function() {
    describe('effectsGet', function() {
      it('should call effectsGet successfully', function(done) {
        //uncomment below and update the code to test effectsGet
        //instance.effectsGet(function(error) {
    ...
    describe('effectsPost', function() {
      it('should call effectsPost successfully', function(done) {
        //uncomment below and update the code to test effectsPost
        //instance.effectsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('effectsPreviewsPost', function() {
      it('should call effectsPreviewsPost successfully', function(done) {
        //uncomment below and update the code to test effectsPreviewsPost
        //instance.effectsPreviewsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('masksPost', function() {
      it('should call masksPost successfully', function(done) {
        //uncomment below and update the code to test masksPost
        //instance.masksPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('masksPreviewsPost', function() {
      it('should call masksPreviewsPost successfully', function(done) {
        //uncomment below and update the code to test masksPreviewsPost
        //instance.masksPreviewsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
