...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.RemoveBackgroundApi();
  });
  ...
  describe('RemoveBackgroundApi', function() {
    describe('removebgPost', function() {
      it('should call removebgPost successfully', function(done) {
        //uncomment below and update the code to test removebgPost
        //instance.removebgPost(function(error) {
