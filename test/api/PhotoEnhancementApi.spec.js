...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicsartProgrammableImageApis.PhotoEnhancementApi();
  });
  ...
  describe('PhotoEnhancementApi', function() {
    describe('enhanceFacePost', function() {
      it('should call enhanceFacePost successfully', function(done) {
        //uncomment below and update the code to test enhanceFacePost
        //instance.enhanceFacePost(function(error) {
    ...
    describe('upscaleEnhancePost', function() {
      it('should call upscaleEnhancePost successfully', function(done) {
        //uncomment below and update the code to test upscaleEnhancePost
        //instance.upscaleEnhancePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upscalePost', function() {
      it('should call upscalePost successfully', function(done) {
        //uncomment below and update the code to test upscalePost
        //instance.upscalePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upscaleUltraPost', function() {
      it('should call upscaleUltraPost successfully', function(done) {
        //uncomment below and update the code to test upscaleUltraPost
        //instance.upscaleUltraPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upscaleUltraTransactionIdGet', function() {
      it('should call upscaleUltraTransactionIdGet successfully', function(done) {
        //uncomment below and update the code to test upscaleUltraTransactionIdGet
        //instance.upscaleUltraTransactionIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
