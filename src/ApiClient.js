...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.picsart.io/tools/1.0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.picsart.io/tools/1.0
         */
        ...
        this.authentications = {
            'apiKey': {type: 'apiKey', 'in': 'header', name: 'X-Picsart-API-Key'}
        }
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.picsart.io/tools/1.0",
