...
import EffectsGet200ResponseDataInner from './EffectsGet200ResponseDataInner';

/**
 * The EffectsGet200Response model module.
 * @module model/EffectsGet200Response
 * @version 2.0
 */
class EffectsGet200Response {
    /**
     * Constructs a new <code>EffectsGet200Response</code>.
     * @alias module:model/EffectsGet200Response
     */
    constructor() { 
        
        EffectsGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EffectsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EffectsGet200Response} obj Optional instance to populate.
     * @return {module:model/EffectsGet200Response} The populated <code>EffectsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EffectsGet200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [EffectsGet200ResponseDataInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EffectsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EffectsGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                EffectsGet200ResponseDataInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/EffectsGet200ResponseDataInner>} data
 */
EffectsGet200Response.prototype['data'] = undefined;

/**
 * @member {String} status
 */
EffectsGet200Response.prototype['status'] = undefined;
...
export default EffectsGet200Response;
